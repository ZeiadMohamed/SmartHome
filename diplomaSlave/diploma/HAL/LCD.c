...
{
	DIO_write(RS,LOW);
	DIO_write(D7,READ_BIT(command,7));
	DIO_write(D6,READ_BIT(command,6));
	DIO_write(D5,READ_BIT(command,5));
	DIO_write(D4,READ_BIT(command,4));
	DIO_write(EN,HIGH);
	_delay_ms(1);
	DIO_write(EN,LOW);
	_delay_ms(1);
	DIO_write(D7,READ_BIT(command,3));
	DIO_write(D6,READ_BIT(command,2));
	DIO_write(D5,READ_BIT(command,1));
	DIO_write(D4,READ_BIT(command,0));
	DIO_write(EN,HIGH);
	_delay_ms(1);
	DIO_write(EN,LOW);
	_delay_ms(1);
...
{
	DIO_write(RS,HIGH);
	DIO_write(D7,READ_BIT(data,7));
	DIO_write(D6,READ_BIT(data,6));
	DIO_write(D5,READ_BIT(data,5));
	DIO_write(D4,READ_BIT(data,4));
	DIO_write(EN,HIGH);
	_delay_ms(1);
	DIO_write(EN,LOW);
	_delay_ms(1);
	DIO_write(D7,READ_BIT(data,3));
	DIO_write(D6,READ_BIT(data,2));
	DIO_write(D5,READ_BIT(data,1));
	DIO_write(D4,READ_BIT(data,0));
	DIO_write(EN,HIGH);
	_delay_ms(1);
	DIO_write(EN,LOW);
	_delay_ms(1);
